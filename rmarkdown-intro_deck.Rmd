...
.large[
- Scientific Programmer at [_NCEAS_](https://www.nceas.ucsb.edu/), UCSB

- Previously: Data Engineer Lead at _FindTheBest_ (=> _Graphiq_ => _Amazon_)

- Scientific Background: PhD Environmental Engineering (ecohydrology)

- Organizer of the [_R users Meetup_](https://www.meetup.com/Santa-Barbara-R-Users-Group/) of Santa Barbara
]


---
class: inverse, center, middle
background-image: url(images/nceas-logo-wide.png)
...
.pull-left[### Working group challenges
- No common or compatible tools

- Various data providers

- Facilitate new data ingestion

- Data and workflow centralization
...
- Scaling analysis on NCEAS servers

- Scripted data analysis

- Preserving data and products
]
