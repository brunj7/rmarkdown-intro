...
```{r, LTER logo right, out.width='50%', fig.align="right", fig.cap="LTER logo", results="hide"}
  knitr::include_graphics("images/LTER-logo.png")
```


```{r, LTER logo left, out.width='50%', fig.align="center", fig.cap="LTER logo", echo=FALSE}
knitr::include_graphics("./images/LTER-logo.png")
```
